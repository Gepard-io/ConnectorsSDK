...
final class FeatureTest extends TestCase
{
    ...
    public function testCreateFeatureWithEmptyValueExpectException(): void
    {
        $this->expectException(InvalidArgumentException::class);
        new Feature(
            'testId',
            ...
            TaxonomyFeature::TYPE_TEXT,
            CategoryFeature::PRIORITY_MANDATORY,
            [new FeatureL10n('Test feature (en-GB)', 'en-GB', [''])],
            'unitId',
            'featureGroupId'
        );
    }

    public function testCreateFeatureWithIncorrectValueTypeExpectException(): void
    {
        $this->expectException(InvalidArgumentException::class);
        new Feature(
            'testId',
            ...
            TaxonomyFeature::TYPE_TEXT,
            CategoryFeature::PRIORITY_MANDATORY,
            [new FeatureL10n('Test feature (en-GB)', 'en-GB', [123])],
            'unitId',
            'featureGroupId'
        );
    }
